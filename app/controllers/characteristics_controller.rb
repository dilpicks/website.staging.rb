  ...
  def create
    ...
    respond_to do |format|
      if @characteristic.save
        format.html { redirect_to characteristic_url(@characteristic), notice: "Characteristic was successfully created." }
  ...
  def update
    respond_to do |format|
      if @characteristic.update(characteristic_params)
        format.html { redirect_to characteristic_url(@characteristic), notice: "Characteristic was successfully updated." }
